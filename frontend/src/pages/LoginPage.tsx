    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-base p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-text-secondary mt-1.5">Sign in to your Lumina account</p>
        </div>
        ...
        <p className="text-center text-xs text-text-muted mt-5">
          ...
          <Link to="/register" className="text-violet hover:text-violet-light transition-colors font-medium">
            Create one free
          </Link>
        </p>
      </motion.div>
